...
class WeekSaleReportView(QFrame, ErrorView, ToastView):
    ...
    def set_paid_money(self, paid_money: Money):
        self.payment_money_label.setText(' {} MXN'.format(paid_money.amount))

    def set_total_cost(self, total_cost: Money):
        self.total_cost_label.setText('-{} MXN'.format(total_cost.amount))

    def set_profit_money(self, total_profit: Money):
        self.profit_money_label.setText(' {} MXN'.format(total_profit.amount))

    def set_expense_money(self, expense_money: Money):
        self.expenses_label.setText('-{} MXN'.format(expense_money.amount))
