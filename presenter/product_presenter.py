...
from model.repository.exc.product import UniqueProductNameException, EmptyProductNameException, UniqueProductBarcodeException
...
class ProductPresenter(AbstractPresenter):
    ...
    def __fill_product_form(self, product: Product):
        ...
        view.set_image_path(product.image_path or '')
        view.set_barcode(product.barcode or '')
    ...
    def __construct_product_instance_from_view_fields(self):
        ...
        image_path = view.get_image_path()
        barcode = view.get_barcode()
    ...
    def __handle_errors_on_product_fields(self, error: Exception):
        ...
        elif isinstance(error, UniqueProductBarcodeException):
            self.get_view().show_error_message(str(error))
