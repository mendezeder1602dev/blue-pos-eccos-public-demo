...
class ExpenseFilter:
    ...
    def __match_phrase(self, expense: Expense):
        return (re.search(self.__phrase, expense.name or '') is not None
                or re.search(self.__phrase, expense.description or '') is not None)
...
class ExpenseRepository:
    ...
    def __check_expense_ids_are_assigned_in_database(self, expenses_ids: list):
        ...
        found_ids = {row.id for row in found_expenses_rows}
